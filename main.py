...
from funtools import save_path, my_count
    ...
    if test_text != 0:
        ...
        if test_text == 1 and test_num == 1:
            ...
            try:
                ...
                bar()
                ft.make_my_draw(int(rnds_tf.get()), int(teams_tf.get()), var1.get())
...
run_btn.place(x=100, y=180, anchor=E)
prog_lb.place(x=25, y=250, anchor=W)
progress.place(x=260, y=250, anchor=CENTER)
note_lb.place(x=25, y=300, anchor=W)
who_lb.place(x=25, y=360, anchor=W)
